...
\begin{enumerate}
\item **Metodología**: Éste primer capítulo comienza presentando la metodología a seguir además de algunas definiciones básicas necesarias pertenecientes tanto al ámbito económico como estadístico.
\item **Variables predictoras: información**: Aquí se detalla la información recopilada que se evaluará: definiciones de cada variable así como un breve análisis de sus relaciones.
\item **Proposición de modelos**: Corresponde al análisis estadístico en el que se propondrán distintos modelos lineales sobre los cuales se harán análisis de significancia y distintas comparaciones.
\end{enumerate}
